                    ...
                    <div class="dropdown input-group-text rounded px-0">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="statuschat">
                            <li><a class="dropdown-item" href="javascript:void(0)"><span
                                        class="vm me-1 bg-success rounded-circle d-inline-block p-1"></span> Online</a></li>
                            <li><a class="dropdown-item" href="javascript:void(0)"><span
                                        class="vm me-1 bg-warning rounded-circle d-inline-block p-1"></span> Away</a></li>
                            <li><a class="dropdown-item" href="javascript:void(0)"><span
                                        class="vm me-1 bg-danger rounded-circle d-inline-block p-1"></span> Offline</a></li>
                            <li><a class="dropdown-item" href="javascript:void(0)"><span
                                        class="vm me-1 bg-secondary rounded-circle d-inline-block p-1"></span> Disabled</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col d-grid">
                            <button class="btn btn-outline-secondary border" type="button"><i
                                    class="bi bi-camera-video me-2"></i> Meet
                            </button>
                        </div>
                        <div class="col d-grid">
                            <button class="btn btn-outline-secondary border" type="button"><i
                                    class="bi bi-chat-right-text me-2"></i> Chat
                            </button>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-9 align-self-center ps-0">
                                    <div class="row g-0">
                                        ...
                                        <div class="col-4 text-end"><small class="text-muted fs-10 mb-1"><i
                                                    class="bi bi-check-all text-success"></i> 2 days ago</small></div>
                                    </div>
                                    <p class="text-secondary small text-truncate">Spread love and spread this
                                        template</p>
                                </div>
            ...
            <div class="card border-0 mb-2">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col ps-0">
                            <p><a href="finance-sendmoney.html">Roberto Carlos</a> has requested to send $120.00 money.
                            </p>
                            <p class="text-secondary small">4 days ago <a href="javascript:void(0)"
                                                                          class="float-end text-secondary text-muted"><i
                                        class="bi bi-trash"></i></a></p>
            ...
            <div class="card border-0 mb-2">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col ps-0">
                            <p><a href="profile.html">The Maxartkiller</a> commented: "Thank you so much for this deep
                                view at getWinDOORS..."</p>
...
<div class="chatboxes w-auto align-right mb-2">
    ...
    <div class="dropstart">
        <div class="dd-arrow-none dropdown-toggle" id="thefirstchat" data-bs-display="static" data-bs-toggle="dropdown"
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mw-100 position-relative mb-2 figure">
                                            ...
                                            <img src="img/news-4.jpg" alt="" class="mw-100">
                                        </div>
                        ...
                        <div class="col-12">
                            <div class="chat-block">
                                <div class="row">
                                    <div class="col">
                                        <div class="mw-100 position-relative mb-2 figure">
                                            <video src="https://maxartkiller.com/website/maxartkiller.mp4" controls=""
                                                   preload="none"></video>
                                        </div>
                    ...
                    <div class="row no-margin right-chat">
                        <div class="col-12">
                            <div class="chat-block">
                                <div class="row">
                                    <div class="col">
                                        <p>Ohh... Thats great. WinDOORS is HTML template can be used in various business
                                            domains like
...
<div class="modal fade" id="edittable" tabindex="-1" aria-labelledby="edittableLabel" aria-hidden="true">
        ...
        <div class="modal-content">
                    ...
                    <div class="col-12 col-lg-7 col-xl-7 mb-4 mb-md-0">
                        ...
                        <div>
                            <div class="form-group mb-3 position-relative check-valid">
                                <div class="input-group input-group-lg">
                                    <span class="input-group-text text-theme bg-white border-end-0"><i
                                            class="bi bi-currency-bitcoin"></i></span>
                                    <div class="form-floating">
                                        <input type="text" placeholder="Wallet ID" value="" required=""
                                               class="form-control border-start-0">
                            ...
                            <div class="form-group mb-3 position-relative check-valid">
                                <div class="input-group input-group-lg">
                                    <span class="input-group-text text-theme bg-white border-end-0"><i
                                            class="bi bi-person"></i></span>
                                    <div class="form-floating">
                                        <input type="text" placeholder="Card Holder Name" value="Max Johnson"
                        ...
                        <div class="mb-4">
                            <div class="form-group mb-2 position-relative check-valid is-invalid">
                                <div class="input-group input-group-lg">
                                    ...
                                    <div class="form-floating">
                                        <input type="number" placeholder="Expiry Date" value="" required=""
                                               class="form-control border-start-0">
            ...
            <div class="modal-footer">
                ...
                <div class="col-12 col-lg order-3 order-lg-2">
                    <p class="text-secondary">By providing multiline data in table cell you are actually saving column
                        to make it more spacious and easy to read data. Overall it improves user experience.</p>
                </div>
...
<!-- date range picker -->
<script src="vendor/momentjs/latest/moment.min.js"></script>
...
<script src="vendor/simplelightbox/simple-lightbox.jquery.min.js"></script>

<!-- app tour script-->
<script src="vendor/Product-Tour-Plugin-jQuery/lib.js"></script>
...
<script src="vendor/datatables.net/extensions/Editor/js/dataTables.editor.min.js"></script>

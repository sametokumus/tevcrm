...
<div class="app-theme-panel" id="public-chat-panel">
    <div class="app-theme-panel-container">
        ...
        <div class="app-theme-panel-content">
            ...
            <div class="card">
                <div class="card-header bg-none fw-bold d-flex align-items-center">Chat <a href="#" class="ms-auto text-muted text-decoration-none" data-toggle="theme-panel-expand"><i class="fa fa-expand"></i></a></div>

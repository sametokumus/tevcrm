    ...
    public function getProduct()
    {
        try {
            $products = Product::query()
                ...
                ->select(DB::raw('(select image from product_images where variation_id = variation_id.id order by id asc limit 1) as image'))
                ->leftJoin('product_rules','product_rules.variation_id','=','variation_id.id')

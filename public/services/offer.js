...
async function initOffers(){
    ...
    $.each(offers, function (i, offer) {
        ...
        if (offer.rfq_url != null) {
            pdf_btn =  '<button onclick="openOfferDetailModal(\'' + offer.offer_id + '\');" class="btn btn-sm '+ btn_class +'"><span class="fe fe-edit"> '+ btn_text +'</span></button>\n' +
                '       <a href="offer-print/'+ offer.offer_id +'" class="btn btn-sm btn-theme"><span class="fe fe-edit"> RFQ PDF Düzenle</span></a>\n';

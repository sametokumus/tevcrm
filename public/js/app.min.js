...
var app = {
    ...
    header: {id: "#header", class: "app-header", hasScrollClass: "has-scroll"},
    sidebar: {
        id: "#sidebar",
        class: "app-sidebar",
    ...
    scrollTo: {attr: 'data-toggle="scroll-to"', target: "data-target", linkTarget: "href"},
    themePanel: {
    ...
    breakpoints: {xs: 0, sm: 576, md: 768, lg: 992, xl: 1200, xxl: 1660, xxxl: 1900}
    ...
    a.map(function (e) {
        e.onclick = function (e) {
            e.preventDefault();
            var t = this.nextElementSibling, e = (a.map(function (e) {
    ...
    var e = "." + app.sidebar.class + " ." + app.sidebar.menu.class + " > ." + app.sidebar.menu.itemClass + "." + app.sidebar.menu.hasSubClass,
        ...
        a = e + " > ." + app.sidebar.menu.itemLinkClass, a = [].slice.call(document.querySelectorAll(a));
    ...
    [].slice.call(document.querySelectorAll("[" + app.card.expand.toggleAttr + "]")).map(function (e) {
        return e.onclick = function (e) {
            e.preventDefault();
            var e = this.closest(".card"), t = app.card.expand.class;
    ...
    document.onscroll = function () {
        var e = document.documentElement, t = (window.pageYOffset || e.scrollTop) - (e.clientTop || 0),
            e = (a.map(function (e) {
    ...
    [].slice.call(document.querySelectorAll("[" + app.scrollTo.attr + "]")).map(function (a) {
        a.onclick = function (e) {
            ...
            var e = a.getAttribute(app.scrollTo.target) ? this.getAttribute(app.scrollTo.target) : this.getAttribute(app.scrollTo.linkTarget),
                e = document.querySelectorAll(e)[0], t = document.querySelectorAll(app.header.id)[0].offsetHeight;
            e && (e = e.offsetTop - t - 24, window.scrollTo({top: e, behavior: "smooth"}))
        }
    })
    ...
    [].slice.call(document.querySelectorAll("[" + app.toggleClass.toggleAttr + "]")).map(function (e) {
        e.onclick = function (e) {
            e.preventDefault();
            var e = this.getAttribute(app.toggleClass.toggleAttr), t = this.getAttribute(app.dismissClass.toggleAttr),
    ...
    [].slice.call(document.querySelectorAll("[" + app.themePanel.toggleAttr + "]")).map(function (e) {
        e.onclick = function (e) {
            e.preventDefault();
            var e = document.querySelector("." + app.themePanel.class), t = !1;
    ...
    if (app.variableFontList && app.variablePrefix) for (var t = 0; t < app.variableFontList.length; t++) app.font[app.variableFontList[t].replace(/-([a-z|0-9])/g, (e, t) => t.toUpperCase())] = e.getPropertyValue("--" + app.variablePrefix + app.variableFontList[t]).trim();
    if (app.variableColorList && app.variablePrefix) for (t = 0; t < app.variableColorList.length; t++) app.color[app.variableColorList[t].replace(/-([a-z|0-9])/g, (e, t) => t.toUpperCase())] = e.getPropertyValue("--" + app.variablePrefix + app.variableColorList[t]).trim()
}, handleUnlimitedTopNavRender = function () {
    "use strict";

    function t(e, t) {
        var a = e.closest("." + app.topNav.menu.class), e = window.getComputedStyle(a),
            ...
            n = 0, i = 0, e = a.querySelector(".menu-control-start"), s = e ? e.clientWidth : 0,
            p = a.querySelector(".menu-control-end"), c = s + (e ? p.clientWidth : 0),
        ...
        switch (s && s.map(function (e) {
            ...
            case"prev":
                var d,
                    i = (d = -l) <= r ? (a.querySelector("." + app.topNav.control.class + "." + app.topNav.control.buttonPrev.class).classList.remove("show"), 0) : d - r + c;
    ...
    var e = "." + app.topNav.class + " ." + app.topNav.menu.class + " > ." + app.topNav.menu.itemClass + "." + app.topNav.menu.hasSubClass,
        ...
        a = e + " > ." + app.topNav.menu.itemLinkClass, a = [].slice.call(document.querySelectorAll(a));

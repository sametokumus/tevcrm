...
include('header.php');
$extra_js='
<script src="services/select-product.js"></script>
';
?>
                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="row row-sm mt-5">
                            <div class="col-lg-12">
                                <form method="post" action="" id="filter_product_form">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-sm-3">
                                                    <div class="row mb-4">
                                                        <div class="col-md-12">
                                                            <select name="brand" class="form-control form-select" id="filter_brand" required>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="row mb-4">
                                                        <div class="col-md-12">
                                                            <select name="brand" class="form-control form-select" id="filter_type" required>
                                                ...
                                                <div class="col-sm-1">
                                                    <div class="row mb-4">
                                                        <div class="col-md-12">
                                                            <button type="submit" class="btn btn-primary float-start">Filtrele</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>

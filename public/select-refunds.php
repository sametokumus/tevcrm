...
include('header.php');
$extra_js='
<script src="services/select-refunds.js"></script>
';
?>
                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <h1 class="page-title">İade Talepleri</h1>
                            <div>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">İade Talepleri</li>
                                </ol>
                            </div>
                        </div>
                        <!-- PAGE-HEADER END -->
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">İade Taleplerini İncele</h3>
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table id="refund-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                                <thead>
                                                <tr>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                ...
                                <select name="update_refund_status" id="update_refund_status" class="form-control form-control-md" required>
